    ...
    render() {
        let radioItems = Gender.options.map(
            (option) => {
                ...
                return (
                    <DecorateWithImageAndLabel key={option} imageStyle={icon} label={label} checked={this.state.selectedGender === option} containerStyle="col-xs-5 col-md-5 col-xs-5 radio-col" >
