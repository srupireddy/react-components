...
(function () {
    ...
    var StateMachine = {
        ...
        create: function(cfg, target) {
            ...
            fsm.previous    = function() {var previousState = this.history.pop(); this.current = previousState; return previousState;};
        ...
        buildEvent: function(name, map) {
            return function() {
                ...
                this.transition = function() {
                    ...
                    var previousState = fsm.current;
                    fsm.current = to;
                    StateMachine.enterState( fsm, name, from, to, args);
                    StateMachine.changeState(fsm, name, from, to, args);
                    StateMachine.afterEvent( fsm, name, from, to, args);
                    fsm.history.push(previousState);
